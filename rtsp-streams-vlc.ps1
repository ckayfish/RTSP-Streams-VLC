...
$pathToVlcExe = "e:\Program Files\VideoLAN\VLC\vlc.exe"

# Create one line item for each RTSP Camera
# *Required. Format: "name" = "rtsp://user:password@host/path"
$cameraStreams = [ordered]@{
"Driveway" = "rtsp://rtspuser:RTSPpass32@192.168.1.115/live"
"FrontDoor"= "rtsp://rtspuser:RTSPpass32@192.168.1.116/live"
"Backyard"= "rtsp://rtspuser:RTSPpass32@192.168.1.117/live"
}
...
# *Will default to 2000 (1 second) if value not between 0 and 60000
$buffer = 1000
